...
const TreeViewNode = ({ onToggleExtend, onToggleExtendParent, nodeInfo, leafHeight, leafWidth, children, }) => {
    const { key, expand, show, x, y, expandSvgInfo, parentExpandSvgInfo, parentExpand, } = nodeInfo;
    ...
    return (react_1.default.createElement("div", { style: {
        ...
        (parentsData === null || parentsData === void 0 ? void 0 : parentsData.length) > 0 ? (react_1.default.createElement("div", { onClick: () => {
                // console.log("onClick");
                ...
                cursor: "pointer",
            } }, parentExpand ? "-" : parentsData === null || parentsData === void 0 ? void 0 : parentsData.length)) : null,
        parentExpandSvgInfo ? (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", height: parentExpandSvgInfo.height + 6, width: "60", style: {
                position: "absolute",
                top: ` ${-parentExpandSvgInfo.height / 2 + 40}px`,
                left: `-70px`,
                opacity: parentExpand ? 1 : 0,
            } }, parentExpandSvgInfo.pathsInfo.map((info, i) => (react_1.default.createElement("path", { key: `${key}-${i}`, d: `M ${info.x0} ${info.y0} L ${info.x1} ${info.y1}`, stroke: "#b3b3b3", strokeWidth: "1", fill: "none" }))))) : null,
        children,
